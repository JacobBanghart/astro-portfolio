...
I initially tried to spin this up using [Payload CMS](https://payloadcms.com/) but ran into several issues with out of date dependencies, nextjs build errors, and generally high amounts of complexity that felt heavy and unnecessary for such a small project.   
